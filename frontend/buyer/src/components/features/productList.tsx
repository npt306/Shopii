...
const fetchProductData = async (setProductList: React.Dispatch<React.SetStateAction<any[]>>) => {
    try {
        ...
        <div className="relative my-5 flex flex-col items-center">
            <div className="grid grid-cols-5 gap-3 w-full mb-20">
                {product_list.map((product) => (
                    <div key={product.id} className="relative group" onClick={() => navigate(`/detail-product/${product.id}`)}>
