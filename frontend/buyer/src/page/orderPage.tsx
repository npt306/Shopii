              ...
              <div className="order-list-bg">
                <div className="order-list-tag grid grid-cols-6">
                  <div className=" col-span-2">
                    <h2 className="items-center text-black text-xl">
                      Sản phẩm
                    </h2>
                  </div>
                      ...
                      <div className="col-span-2 item-container-col">
                        ...
                        <span className="item-name">
                          <span className="overflow-hidden overflow-ellipsis whitespace-nowrap">
                            Item
                            nameeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                          </span>
                        </span>
                      </div>
                  ...
                  <div className="order-shop-settings">
                    ...
                    <div className="flex flex-col text-sm">
                      <div className="shipping-container">
                        ...
                        <button className="row-end-2 cursor-pointer col-end-4 capitalize !text-sky-700">
                          Thay đổi
                        </button>
            ...
            <div className="">
              <div className="bg-white mt-[20px]">
                <div className="items-center flex min-h-[90px] px-8 ">
                  ...
                  <button className="!text-sky-700 cursor-pointer !ml-[110px] !uppercase">
                    Thay đổi
                  </button>
                </div>
              </div>
              ...
              <div className="total-total-bg ">
                ...
                <div className="title-total total-total !text-orange-600 text-3xl font-medium">
                  ₫990.800
                </div>
              </div>
              <div className="total-total-bg ">
            ...
            <div className="z-1">
              <div className="voucher-modal-container">
                ...
                <div className="voucher-modal-footer">
                  <button className="gray-button !mr-3">Trở lại</button>
                  <button className="color-button">OK</button>
                </div>
              </div>
            </div>
                      ...
                      <div role="radiogroup">
                          ...
                          <div className="min-w-[0] w-full">
                            ...
                            >
                              ...
                              >
                                ...
                                <div
                                  role="row"
                                  className="addr-info flex items-center"
                                >
                                  (+84) 123 456 789
                                </div>
                              </div>
                              <div className="[flex-basis:40px] flex justify-end">
                                <button className="addr-change">
                                  Cập nhật
                                </button>
                              </div>
                            </div>
                            ...
                            >
                              <span
                                role="mark"
                                className="address-type default"
                              >
                                Mặc định
                              </span>
                            </div>
                        ...
                        <div className="address-info">
                          ...
                          <div className="min-w-[0] w-full">
                            ...
                            >
                              Số điện thoại hoặc địa chỉ nhận hàng chưa chính
                              xác. Vui lòng kiểm tra và cập nhật.
                            </div>
                          </div>
                        </div>
                      </div>
