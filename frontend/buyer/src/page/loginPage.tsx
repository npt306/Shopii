...
export const LoginPage: React.FC = () => {
  ...
  const [isWithQR, setIsWithQR] = useState<boolean>(false);
  ...
  return (
    <Container fluid className="login-page vh-100 d-flex flex-column">
      ...
      <Row className="login-title align-items-center py-3">
        ...
        <Col className="">
          <div className="text-2xl">{isLogin ? "Đăng nhập" : "Đăng ký"}</div>
        </Col>
        <Col md={8} className="text-end">
          <Button variant="link" className="link-button text-decoration-none">
            Bạn cần giúp đỡ?
          </Button>
        </Col>
      </Row>
                        ...
                        <div className="popup-help flex flex-col justify-center items-center">
                          <div className="_1wOMD">
                            ...
                            <div className="A4htHe mb-2">
                              Nhấn vào biểu tượng quét mã trên ứng dụng Shopee
                              để mở trình quét mã QR
                            </div>
                          </div>
                        </div>
                      )}
                  ...
                  <>
                    ...
                    <Form.Group className="mt-3 mb-3">
                      <div className="flex justify-between">
                        ...
                        <a
                          href="/sms-login"
                          className="text-xs text-blue-900 text-decoration-none"
                        >
                          Đăng nhập với SMS
                        </a>
                      </div>
                    ...
                    <button
                      className="w-full normal-button py-2 px-4 rounded-none"
                      type="submit"
                      disabled={loading}
                    >
                ...
                <>
                  ...
                  <Form.Group className="mt-3 mb-3 flex justify-center gap-2">
                    ...
                    <button
                      ...
                      onClick={() => {
                        const keycloakUrl =
                          "https://sso-shopii.ddns.net/realms/shopii/protocol/openid-connect/auth";
                  ...
                  {isLogin ? (
                    <>
                      ...
                      <a
                        ...
                        className="link-button text-decoration-none cursor-pointer"
                      >
                        Đăng ký
                      </a>
                    </>
