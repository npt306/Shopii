          ...
          <Card className="login-card">
            ...
            {OtpSent ? (
              ...
              <div className="d-flex flex-column align-items-center justify-content-center text-center w-80">
                <svg aria-hidden="true" width={80} height={80} fill="none" className="my-4">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                ...
                <button className="send-otp-button" type="button" onClick={() => handleSendOtp()}>
                  <svg aria-hidden="true" width={20} height={20} fill="none">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M1.6665 5.00016C1.6665 4.07969 2.4127 3.3335 3.33317 3.3335H16.6665C17.587 3.3335 18.3332 4.07969 18.3332 5.00016V15.0002C18.3332 15.9206 17.587 16.6668 16.6665 16.6668H3.33317C2.4127 16.6668 1.6665 15.9206 1.6665 15.0002V5.00016ZM3.33317 4.5835H16.6665C16.8966 4.5835 17.0832 4.77004 17.0832 5.00016V5.36012L9.99984 10.0823L2.9165 5.36012V5.00016C2.9165 4.77004 3.10305 4.5835 3.33317 4.5835ZM2.9165 6.86243V15.0002C2.9165 15.2303 3.10305 15.4168 3.33317 15.4168H16.6665C16.8966 15.4168 17.0832 15.2303 17.0832 15.0002V6.86243L10.3465 11.3535C10.1366 11.4935 9.86309 11.4935 9.65315 11.3535L2.9165 6.86243Z"
                      fill="#ee4d2d"
                      fillOpacity=".9"
                    />
                  </svg>
