...
const RefundOrder = () => {
  ...
  const tabActionsMap: { [key: string]: string[] } = {
    "Tất cả": ["Cần cung cấp bằng chứng", "Kiểm tra hàng hoàn", "Phản hồi quyết định hoàn tiền của Shopee"],
    "Đang xem xét": ["Cần cung cấp bằng chứng"],
    "Đang trả hàng cho Người bán": ["Cần cung cấp bằng chứng", "Kiểm tra hàng hoàn"],
    "Đã hoàn tiền cho Người mua": ["Phản hồi quyết định hoàn tiền của Shopee"],
