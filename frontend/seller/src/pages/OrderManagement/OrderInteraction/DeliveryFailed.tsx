...
const DeliveryFailed = () => {
  ...
  const tabFilterMap: { [key: string]: string[] } = {
    ...
    "Đã trả hàng cho Người bán": ["Tất cả", "Hết hạn sau 1 ngày", "Hết hạn sau 2 ngày"],
    "Trả hàng không thành công": ["Tất cả", "Hết hạn sau 1 ngày", "Hết hạn sau 2 ngày"],
    "Thất lạc": [],
  };
  const [activeFilter, setActiveFilter] = useState(tabFilterMap["Tất cả"][0]);

  const tabActionsMap: { [key: string]: string[] } = {
    "Tất cả": ["Kiểm tra hàng hoàn"],
    "Đang trả hàng cho Người bán": ["Kiểm tra hàng hoàn"],
    "Đã trả hàng cho Người bán": ["Kiểm tra hàng hoàn"],
    "Trả hàng không thành công": ["Kiểm tra hàng hoàn"],
    "Thất lạc": [],
  };
